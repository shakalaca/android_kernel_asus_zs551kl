...
static DEVICE_ATTR(i2c_bus_debug, 0644, show_debug, store_debug);
/*
* ASUS_BSP +++
*/
...
static struct attribute *i2cutil_attributes[] = {
	&dev_attr_i2c_read_reg.attr,
	&dev_attr_i2c_write_reg.attr,
	NULL
};

const struct attribute_group i2cutil_attr_group = {
	.attrs = i2cutil_attributes,
};
...
i2c_new_device(struct i2c_adapter *adap, struct i2c_board_info const *info)
{
	...
	status = sysfs_create_group(&client->dev.kobj, &i2cutil_attr_group);
	i2cutil_reg_addr = 0;
	i2cutil_reg_read_len = 0;
