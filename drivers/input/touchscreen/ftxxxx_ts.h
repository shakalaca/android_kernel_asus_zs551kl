...
#define FT_I2C_VCC_MIN_UV	1880000
#define FT_I2C_VCC_MAX_UV	1880000
...
#define FTXXXX_REG_TOUCH_IC 0xa0
#define FTXXXX_REG_FT_ID 0xBF
...
/*++++ nancy add 20150923++++*/
#define TP_JT_TM 0x81
#define TP_GIS_AUO 0x63
#define TP_GIS_TM 0x61
#define TP_GIS_CTC 0x69
#define TP_BIEL_TM 0x31
#define TP_BIEL_CTC 0x39

#define TP_JT_AUO 0x83
...
struct focal_i2c_platform_data
{
	...
	u32 tp0id_gpio;
	u32 tp1id_gpio;
	u32 lcd0id_gpio_flag;
	u32 tp0id_gpio_flag;
	u32 lcd1id_gpio_flag;
	u32 tp1id_gpio_flag;
	bool have_key;
    u32 key_number;
    u32 keys[4];
